    ...
    <div className="min-h-screen flex items-center justify-center bg-[#060810] px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-xs mt-2 uppercase tracking-widest font-mono">Terminal Enrollment</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-[10px] uppercase tracking-widest text-gray-500 font-mono mb-2 ml-1">Full Name</label>
            <input 
              type="text" 
              value={name}
        ...
        <p className="text-center text-gray-600 text-[10px] uppercase tracking-widest mt-8 font-mono">
          Already have access? <Link to="/login" className="text-[#C9A84C] hover:underline">Login</Link>
        </p>
      </motion.div>
    </div>
  );
