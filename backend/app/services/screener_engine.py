...
SYMBOLS = [
    ...
    "HINDUNILVR.NS", "ITC.NS", "SBI.NS", "BHARTIARTL.NS", "KOTAKBANK.NS",
    ...
    "ADANIENT.NS", "ADANIPORTS.NS", "ONGC.NS", "DRREDDY.NS", "HCLTECH.NS",
    "TATAMOTORS.NS", "JSWSTEEL.NS", "GRASIM.NS", "CIPLA.NS", "SBILIFE.NS",
